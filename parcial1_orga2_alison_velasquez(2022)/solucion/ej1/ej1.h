...
typedef struct msg {
	char * text;	 //off 0 -> ocupa 8 bytes
	size_t text_len; //off 8 -> ocupa 4 bytes
	int tag;		 //off 12 -> ocupa 4 bytes (12 es multiplo de 4) 
} msg_t; //la struct ocupa 16 bytes, ya esta alineada a 8
